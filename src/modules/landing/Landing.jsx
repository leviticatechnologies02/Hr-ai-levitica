  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 overflow-x-hidden">
                  ...
                  <div className="relative h-full flex items-center justify-center text-center px-4">
                    <div className="max-w-4xl mx-auto text-white">
                      ...
                      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link 
                          to="/login"
                          className="px-8 py-4 rounded-full bg-blue-600 text-white font-bold text-lg hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-600/30 transition-all duration-300 w-full sm:w-auto"
                        >
                          Get Started
                        </Link>
                        <Link 
                          to="/pricing"
                          className="px-8 py-4 rounded-full bg-white/10 backdrop-blur-md text-white font-bold text-lg border border-white/30 hover:bg-white/20 transition-all duration-300 w-full sm:w-auto"
                        >
                          View Pricing
                        </Link>
                      </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-4xl font-extrabold text-slate-900 mb-4">What We Offer</h2>
          ...
          <div className="bg-slate-900 rounded-3xl p-8 md:p-16 relative overflow-hidden shadow-2xl" data-aos="fade-up">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <button className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-3 px-8 rounded-full hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:-translate-y-1">
                  Learn More About Us
                </button>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center" data-aos="zoom-in" data-aos-delay="200">
                  <div className="text-4xl md:text-5xl font-black text-blue-400 mb-2">35+</div>
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center" data-aos="zoom-in" data-aos-delay="300">
                  <div className="text-4xl md:text-5xl font-black text-pink-400 mb-2">14+</div>
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 text-center" data-aos="zoom-in" data-aos-delay="500">
                  <div className="text-4xl md:text-5xl font-black text-amber-400 mb-2">99%</div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12" data-aos="fade-up">
            <h2 className="text-4xl font-extrabold text-slate-900 mb-4">Pricing & Plans</h2>
            ...
            {pricingPlans.map((plan, idx) => (
              ...
              >
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <Link to="/pricing" className={`block w-full py-3 px-6 text-center rounded-xl font-bold transition-all duration-300 ${plan.popular ? 'bg-blue-600 text-white hover:bg-blue-700 hover:shadow-lg' : 'bg-slate-100 text-slate-800 hover:bg-slate-200'}`}>
                    Choose Plan
                  </Link>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="w-full lg:w-1/2" data-aos="fade-right">
              <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-8">Frequently Asked Questions</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-blue-600 rounded-3xl p-8 md:p-12 shadow-2xl text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden" data-aos="zoom-in">
            ...
            <div className="relative z-10 max-w-2xl">
              <h3 className="text-3xl md:text-4xl font-extrabold text-white mb-4">Ready to accelerate your hiring?</h3>
            ...
            <div className="relative z-10 flex flex-col sm:flex-row gap-4 w-full md:w-auto shrink-0">
              <Link 
                to="/login"
                className="px-8 py-4 bg-white text-blue-600 font-bold rounded-full hover:bg-slate-50 hover:shadow-lg transition-all duration-300 text-center shadow-md"
              >
                Get Started Free
              </Link>
              <Link 
                to="/pricing"
                className="px-8 py-4 bg-transparent border-2 border-white/30 text-white font-bold rounded-full hover:bg-white/10 transition-all duration-300 text-center"
              >
                View All Plans
              </Link>
            </div>
